#
# Copyright (C) 2024 by THE-RAUSHAN -BOY-OP@Github, < https://github.com/THE-RAUSHAN -BOY-OP >.
#
# This file is part of < https://github.com/THE-RAUSHAN -BOY-OP/RAUSHAN -MUSIC > project,
# and is released under the MIT License.
# Please see < https://github.com/THE-RAUSHAN -BOY-OP/RAUSHAN -MUSIC/blob/master/LICENSE >
#
# All rights reserved.
#
import math
...
def stream_markup_timerr(_, videoid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="✚ ᴘʟᴀʏʟɪsᴛ", callback_data=f"RAUSHAN _playlist {videoid}"
            ),
            InlineKeyboardButton(
                text="ᴄᴏɴᴛʀᴏʟs ♻",
...
def playlist_markupp(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"RAUSHAN Playlists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            InlineKeyboardButton(
                text=_["P_B_2"],
                callback_data=f"RAUSHAN Playlists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [
            InlineKeyboardButton(
...
def panel_markup_clone(_, vidid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="✚ ᴘʟᴀʏʟɪsᴛ ✚", callback_data=f"RAUSHAN _playlist {vidid}"
            ),
        ],
    ]
